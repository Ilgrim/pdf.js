  ...
  _createClass(PDFFindController, [{
    ...
    value: function _reset() {
      ...
      this._firstPagePromise = new Promise(function (resolve) {
        var onPagesInit = function onPagesInit() {
          if (!_this2._pdfDocument) {
            throw new Error('PDFFindController: `setDocument()` should have been called.');
          }
          _this2._eventBus.off('pagesinit', onPagesInit);
          resolve();
        };
        _this2._eventBus.on('pagesinit', onPagesInit);
      });
    }
  }, {
    key: '_normalize',
    ...
    value: function _onFindBarClose(evt) {
      ...
      this._firstPagePromise.then(function () {
        ...
        _this5._eventBus.dispatch('updatetextlayermatches', {
          source: _this5,
          pageIndex: -1
        });
      });
